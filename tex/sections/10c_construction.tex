...
of which mentions a general point. Only the second is a criterion. The first
is settled by \Cref{thm:p1equivalent}, and we record it because it is the
form in which the question first presents itself.
...
\item \emph{A rank.} The semiregularity map of a perfect complex with the
  Chern character of \Cref{prop:ktheory} at one base point is injective. Its
