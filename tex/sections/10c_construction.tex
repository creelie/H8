...
$\Ext^{<0}(E,E)\ne0$, which that stack excludes, use instead the analytic
Kuranishi germ of pairs of the proof of \Cref{thm:p2false}, with the same
tangent and obstruction spaces; the argument below then gives a nonempty
...
of the Cayley form. The Hodge locus of $\gamma$ near $A$ is the orbit of $A$
...
\cite[Theorem~23.1]{Mat86}. The analytic Kuranishi germ of pairs, as in the
