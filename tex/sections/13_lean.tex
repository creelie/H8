...
\texttt{frontier\_}\allowbreak\texttt{suffices} & it is in the closure once (F3) alone is adjoined, which is \Cref{prop:f3ishc}; once $\{\mathrm{L},\mathrm{M}\}$, $\{\mathrm{L},\mathrm{F3}'\}$, $\{\mathrm{V},\mathrm{F3}'\}$ or $\{\mathrm{P2},\mathrm{F2},\mathrm{F3}'\}$ is; and, not minimally, once $\{\mathrm{P2},\mathrm{F2},\mathrm{F3}\}$, $\{\mathrm{L},\mathrm{F3}\}$ or $\{\mathrm{V},\mathrm{F3}\}$ is \\
...
\texttt{frontier\_}\allowbreak\texttt{smallest} & of the thirteen open statements exactly one, (F3), suffices alone, and of the seventy-eight pairs exactly those containing (F3) and the pairs $\{\mathrm{L},\mathrm{M}\}$, $\{\mathrm{L},\mathrm{F3}'\}$, $\{\mathrm{V},\mathrm{F3}'\}$ do \\
