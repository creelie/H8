...
Voisin's account of the present state of the subject \cite{Voi26}, and
Totaro's \cite{Tot26}, make the same point qualitatively and for the
variational Hodge conjecture at large, that semiregular objects are hard to
construct and too restricted to carry a general argument. \Cref{cor:kernelfamily} is that observation in quantitative form
for one family of classes: the restriction is exactly $n^{2}$ dimensions, and
those dimensions are the family.
\end{remark}
