...
\item \emph{The closure graph.} The script \texttt{closure\_\allowbreak graph.py}
  ...
  is a label of this paper, against the list of all $528$ labels generated
...
Items (I), (II), (III), (VI), (VII), (VIII) and (X) to (L) are the ones
...
Running \texttt{verify\_all.py} executes the forty-five Python items and
prints \texttt{853 checks passed, 0 failed}; items (XXIX), (XXXI) and
