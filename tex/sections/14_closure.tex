...
\item \emph{One finite sufficient condition, false in its first form, and
  ...
  the shapes $c\,\theta^{2n}$ and $c\,e^{t\theta}$ with $t\theta$ the class of
  a line bundle, of Hankel rank at most one, are excluded as the pure form
  was (\Cref{thm:p2primenumber}). The
