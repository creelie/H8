...
line \texttt{865 checks passed, 0 failed}. Everything requires the standard library of Python~3,
...
\begin{verbatim}
  ...
  [PASS] the route through this paper, with red_ab_mod, is the only
       ...
       with
            P2             at a base point of every Weil family of every
                           CM field, a complex whose Chern character is
                           a nonzero Weil class plus a polynomial in the
                           polarisation has injective semiregularity map
                           (rem:p2prime); the first form, with Chern
                           character exactly a Weil class, is false by
                           thm:p2false
