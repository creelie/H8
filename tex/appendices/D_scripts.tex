...
\begin{verbatim}
  [PASS] the minimal sufficient sets are enumerated exhaustively
         2 of them, over the 12 open statements, from 4096 subsets
  [PASS] the minimal sufficient sets are exactly two
  ...
  [PASS] the route through this paper and the two routes of the
         literature through red_ab suffice and are not minimal
  ...
  [PASS] every member of a minimal sufficient set is a consequence of
         the conjecture, and P2 is in none of them
         lef_B by thm:equivalence, mot by prop:lefmot, red_ab directly;
         no implication from the conjecture to P2 is known
  [PASS] each minimal sufficient set is an equivalence with the
         conjecture
  ...
  [PASS] no minimal sufficient set uses a statement proved in this paper
  ...
  [PASS] the secant route lies in no minimal sufficient set
         ...
         to the conjecture
  [PASS] the secant route, fully granted, reaches the trivial
         discriminant and stops
  ...
  [PASS] without the rule of prop:f3ishc the search returns the four
