...
\begin{verbatim}
  [PASS] the minimal sufficient sets are enumerated exhaustively
         5 of them, over the 13 open statements, from 8192 subsets
  ...
  [PASS] the route through this paper, with red_ab_mod, is the only
       ...
       with
            P2             the semiregularity map of a complex with the
                           Weil Chern character at a base point is
                           injective, in every Weil family of every CM
                           field; it forces the evaluation map to vanish
                           on the annihilator of the Weil class
